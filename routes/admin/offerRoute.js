...
router.post("/offers/referral-control", adminMiddleware, updateReferralCodeControlController);
router.post("/offers/referral-control/clear-users", adminMiddleware, clearAllUserReferralCodesController);
